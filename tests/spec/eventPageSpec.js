describe("AliaserList", function() {
	...
	it("Data file is empty to start with", function() {
		aliaser._setRawData("");
		expect(aliaser._getRawData()).toEqual("");
	    });
	it("Master List is empty to start with too", function() {
	...
	it("Data file saves and retrieves properly", function() {
		aliaser._setRawData("doomy doomy doom");
		expect(aliaser._getRawData()).toEqual("doomy doomy doom");
	...
	it("Alias is added correctly", function() {
		...
		expect(aliaser._getRawData()).toEqual("doom http://www.doom.com");
	...
	it("An alias value without a protocol gets one added to it", function() {
		...
		expect(aliaser._getRawData()).toEqual("doom http://www.doom.com tak http://thehideousnewgirl");
	...
	it("An alias with an https:// protocol gets added correctly", function() {
		...
		expect(aliaser._getRawData()).toEqual("doom http://www.doom.com tak http://thehideousnewgirl map https://maps.google.com/map?q=%s&lci=%s");
	...
	it("An alias with a chrome:// protocol gets added correctly", function() {
		...
		expect(aliaser._getRawData()).toEqual("doom http://www.doom.com tak http://thehideousnewgirl map https://maps.google.com/map?q=%s&lci=%s gir chrome://tacos");
	...
	it("An alias with an ftp:// protocol gets added correctly", function() {
		...
		expect(aliaser._getRawData()).toEqual("doom http://www.doom.com tak http://thehideousnewgirl map https://maps.google.com/map?q=%s&lci=%s gir chrome://tacos ftp ftp://sftp");
	...
	it("An alias with a file:// protocol gets added correctly", function() {
		...
		expect(aliaser._getRawData()).toEqual("doom http://www.doom.com tak http://thehideousnewgirl map https://maps.google.com/map?q=%s&lci=%s gir chrome://tacos ftp ftp://sftp file file://undercover");
	...
	it("Deletes aliases correctly from data file", function() {
		...
		expect(aliaser._getRawData()).toEqual("doom http://www.doom.com tak http://thehideousnewgirl gir chrome://tacos ftp ftp://sftp file file://undercover");
	...
	it("Replaces duplicates in data file on add", function() {
		...
		expect(aliaser._getRawData()).toEqual("doom http://www.doom.com gir chrome://tacos ftp ftp://sftp file file://undercover tak http://taknewvalue");
	...
	it("Truncates too-long aliases", function() {
		...
		expect(aliaser._getRawData()).toEqual("thisaliasisalittleto http://justalittletoolong");
	    });
	...
	it("Ignores leading and trailing spaces", function() {
		...
		expect(aliaser._getRawData()).toEqual("thisaliasisalittleto http://justalittletoolong spacey http://somanyspacesforsomereason");
